...
print "\n";
print "Ce document est une traduction Francaise de l'Anglais du module XML::Reader. Pour\n";
print "obtenir la source Perl du module, consultez le fichier XML/Reader.pm\n";
print "\n";
